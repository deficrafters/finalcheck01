...
export default function GameCard({
  ...
  return (
    <div style={{backgroundColor:disabled?"#060714":"",borderWidth:disabled?1:0}} className={`flex-shrink-0 rounded-radius-md overflow-hidden`}>
      <div style={{backgroundColor:disabled?"#060714":"",borderWidth:disabled?1:0}} className="w-[100%] bg-cool-20 px-5 py-4 flex items-center justify-between">
      ...
      <div
      style={{backgroundColor:disabled?"#060714":"",borderWidth:disabled?1:0}}
      ...
      <div style={{backgroundColor:disabled?"#060714":"",borderWidth:disabled?1:0}} className="bg-cool-20/60 p-6 flex items-center justify-between">
