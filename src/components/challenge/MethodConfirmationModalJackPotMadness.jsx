...
const TicketModal = ({
  ...
  async function handle_Buy_Now() {
    ...
    let Final_Amount = Number(TicketPrice) - Number(GiveFreeTicket);
  ...
  const Check_How_Much_Cost_User_Need_To_PAY = (Selected_Token) => {
    ...
    let Amount_In_USDT = counter * 1;

    // alert(Amount_In_USDT)
  ...
  return (
    ...
    >
      <div className='flex h-[80vh] lg:h-auto px-3 items-center justify-center'>
