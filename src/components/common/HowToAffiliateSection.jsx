            ...
            {coinQuest.map((item, index) => (
              <SwiperSlide key={index} className={`last:!mr-0 `}>
                ...
                >
                  ...
                  >
                    <span className={`swiper-no-swiping text-white font-semibold`}>
                      
                     {index == 0 && "Share your referral link."}
                    {index == 1 && "User completes registration using your link."}
                    {index == 2 && "You are instantly awarded 0.5 USDT & 10,000 DMZT tokens."}
